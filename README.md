...
Plugin list index + metadata ist provided here: https://plugin-data.nuonic.dev/shopware_extensions_v1.json

This file is updated every 30 minutes by a github action to refelct the current metadata of all available plugins in the packagist registry.
